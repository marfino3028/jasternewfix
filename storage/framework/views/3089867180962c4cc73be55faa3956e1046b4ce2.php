            ...
            <div class="col-12 rounded-left rounded-top rounded-bottom">
                <div class="card rounded-right rounded-left rounded-top rounded-bottom">
                    ...
                    <div class="card-body col-md-12">
                        ...
                        <div class="col-12">
                            <div style="font-family: sans-serif;font-size: 24px">Total Order : Rp. <?php echo e(number_format(0,0,',','.')); ?>-,</div>
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jasternew\resources\views/backend/pages/add-order.blade.php ENDPATH**/ ?>